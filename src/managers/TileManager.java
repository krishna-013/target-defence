...
import static helps.Constants.Tiles.WATER_TILE;

import java.awt.image.BufferedImage;
import java.util.ArrayList;

import helps.ImageFix;
...
public class TileManager {
	...
	private void createTiles() {
		...
		corners.add(BL_WATER_CORNER = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(5, 0), 0), id++,
				WATER_TILE));
		corners.add(TL_WATER_CORNER = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(5, 0), 90), id++,
				WATER_TILE));
		corners.add(TR_WATER_CORNER = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(5, 0), 180), id++,
				WATER_TILE));
		corners.add(BR_WATER_CORNER = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(5, 0), 270), id++,
				WATER_TILE));

		beaches.add(
				T_WATER = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(6, 0), 0), id++, WATER_TILE));
		beaches.add(R_WATER = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(6, 0), 90), id++,
				WATER_TILE));
		beaches.add(B_WATER = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(6, 0), 180), id++,
				WATER_TILE));
		beaches.add(L_WATER = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(6, 0), 270), id++,
				WATER_TILE));

		islands.add(
				TL_ISLE = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(4, 0), 0), id++, WATER_TILE));
		islands.add(TR_ISLE = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(4, 0), 90), id++,
				WATER_TILE));
		islands.add(BR_ISLE = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(4, 0), 180), id++,
				WATER_TILE));
		islands.add(BL_ISLE = new Tile(ImageFix.getBuildRotImg(getAniSprites(0, 0), getSprite(4, 0), 270), id++,
				WATER_TILE));
